  ...
  <div class="row">
    ...
    <div class="span4">
      <div class="well">
        ...
        <a href="<?php echo base_url() . "register?redirect=" . urlencode(current_url() . "?" . $querystring); ?>"
           class="btn block">Create Your Account</a>
      </div>
    </div>
    <div class="span1"> &nbsp;</div>
    <div class="span4">
...
<?php } else {
  ...
  <form class="form-horizontal span5" action="<?php echo base_url() . "order/placeOrder" ?>" method="POST"
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <textarea name="shippingaddress" id="shippingaddress" class="input-large autogrow"
                  placeholder="Enter Your Address"><?php echo $formData["shippingaddress"]; ?></textarea>
        <br/>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <select name="shipping_area" id="shipping_area"
                onchange="$('#shipping_PIN').val($(this).find('option:selected').attr('data'));">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="shipping_PIN" name="shipping_PIN" value="<?php echo $formData["shipping_PIN"]; ?>"
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="recieving_date" class="datepickerele" name="recieving_date"
               value="<?php echo date("d/m/Y"); ?>" placeholder="Recieving Date"/> <br/>
