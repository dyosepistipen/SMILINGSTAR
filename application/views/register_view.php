...
<div class="well">
  <form class="form-horizontal" id="register_form" onsubmit="validateuser(this,event)"
        action="<?php echo base_url() . "register/submitform/?redirect=" . urlencode($obj->redirect); ?>" method="POST">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="password" id="password" name="password" value="<?php echo $formData["password"]; ?>"
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="password" id="confpassword" name="confpassword" value="<?php echo $formData["confpassword"]; ?>"
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="first_name" name="first_name" value="<?php echo $formData["first_name"]; ?>"
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="middle_name" name="middle_name" value="<?php echo $formData["middle_name"]; ?>"
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="last_name" name="last_name" value="<?php echo $formData["last_name"]; ?>"
               placeholder="Last Name">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        ...
        <span
          class="errormsg"><?php echo form_error('date') . " " . form_error('month') . " " . form_error('year'); ?></span>
      </div>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <textarea name="address" id="address" class="input-xlarge autogrow"
                  placeholder="Enter Your Address"><?php echo $formData["address"]; ?></textarea>
