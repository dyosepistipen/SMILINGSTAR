...
<head>
  ...
  <!-- Bootstrap style -->
  <link id="callCss" rel="stylesheet" href="<?php echo $theme_url; ?>themes/bootshop/bootstrap.min.css?allowall=allow"
        media="screen"/>
      ...
      <div class="pull-right">
        ...
        if (!$obj->hidecartlist) {
          ...
          <div class="pull-right btn-group span12" id="bt-it">
            <a href="#" id="showcartbtn" class="pull-right btn btn-mini btn-primary dropdown-toggle"
               style="position: relative;" data-toggle="dropdown"><span><i class="icon-shopping-cart icon-white"></i> [ <span
                  class="item-cart-count"><?php echo $obj->carttotalitems; ?></span> ] Item(s) in your cart </span> </a>
            <ul class="dropdown-menu span6" id="show-cart-dropdown"
                style="position: absolute;right:-20px; background-color: #ffffff;border: 2px solid #005580;padding: 1px;">
              <li>
                <center>
                  <div
                    style="width : 95%;white-space: normal;color: #005580;font-weight: bolder;font-size: 14px;padding-top: 10px;">
              ...
              <li>
                <center style="padding : 10px;">
                  <div style="width : 95%;border: 1px solid rgba(0, 85, 128, 0.31);"></div>
                </center>
              </li>
                ...
                <center>
                  <table class="cart-table" border="0">
                    ...
                    <tr>
                      <th colspan="100">
                        <center>
                          <div style="width : 100%;border: 1px solid rgba(0, 85, 128, 0.31);"></div>
                        </center>
                      </th>
                    </tr>
                    </thead>
	...
	<div class="span3">
      ...
      <ul id="topMenu" class="nav pull-right">
        ...
        <li class="">
          ...
          ?>
          <a
            href="<?php echo base_url() . "home/logout?redirectlink=" . urlencode(current_url() . "?" . $querystring); ?>"
            role="button" style="padding-right:0"><input type="submit" class="btn btn-large btn-danger" value="Logout"/></a>
        </li>
        <?php
        }
        else {
            ...
            <div class="modal-body">
              <form class="form-horizontal loginFrm" method="POST" action="<?php echo base_url() . "home/login"; ?>">
                ...
                <input type="hidden" name="redirectlink"
                       value="<?php echo urlencode(current_url() . "?" . $querystring); ?>"/>
                <div class="control-group">
                  <label class="checkbox">
                    <input type="checkbox" name="rememberme"><span> Remember me </span><br/>
                    <a
                      href="<?php echo base_url() . "home/forgotpassword?redirectlink=" . urlencode(current_url() . "?" . $querystring); ?>">Forgot
                      Password</a>
                  </label>
                </div>
