  ...
  function addGridView(data) {
    ...
    for (i in data) {
      ...
      if (data[i].product_image)
        strHtml += '<img src="' + data[i].product_image
      alt = "" / > ';
      ...
      if (data[i].discount_status == '1') {
        strHtml += '<strong>Price&nbsp;:</strong>&nbsp;<span class = "price-number" style = "text-decoration:line-through;color : red;">Php.' + data[i].product_price + '/-</span>'
          + '<strong>Discount&nbsp;Price&nbsp;:</strong>&nbsp;<span class = "price-number" style = "">Php.' + data[i].discount_price + '/- </span>';
      }
      else {
        strHtml += '<strong>Price&nbsp;:</strong>&nbsp;<span class = "price-number">Php.' + data[i].product_price + '/-</span>';
      }
      strHtml += '		</div>	'
        + '		</div>'
        + '	  </div>'
