...
?>
<div>
  <a href="" class="btn btn-large btn-info addproduct"
     onclick="$('#productmodal').show('slow');$(this).hide('slow');return false;">Create Product</a>
</div>
...
<script>
  ...
  (
    function () {
      ...
      $(".close,.closebtn").bind("click", function () {
        $("#productmodal").hide("slow");
      ...
      var chk = setInterval(function () {
        $(".editbtn").attr("onclick", "window.scrollTo(0,0);$('.addproduct').show('slow');$('#productmodal').show('slow');return false;");
      }, 1000);
    }
  );
