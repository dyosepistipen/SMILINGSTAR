...
<form id="final_order" action="<?php echo base_url() . "admin/sales/finalizedOrder" ?>" method="POST">
  ...
  <table class="table table-bordered">
    ...
    <tr>
      ...
      <td>
        <input type="text" disabled="disabled"
               value="<?php echo $orderData["firstname"] . " " . $orderData["lastname"]; ?>"/>
      </td>
    </tr>
    <tr>
      <th>
    ...
    <tr>
      ...
      <td>
        <select name="area"
                onchange="$(this).find('option').each(function(){if($(this).is(':selected'))$('#shppin').val($(this).attr('pin'))})">
          <?php
          if ($areas) {
    ...
    <tr>
      <th>
        ...
        <br/><br/><br/><br/>
        <center>
          <a href="#" onclick="$('#addproductmodal').modal('show');return false;" class="btn btn-info btn-setting">Add
            Product</a>
        </center>
      </th>
      <td>
...
<center>
  ...
  <span class='btn btn-danger'
        onclick="if(confirm('Are you sure you want to close this window? All your changes will be lost.'))window.close();">Close Window</span>
</center>
...
<div class="modal hide fade in" id="addproductmodal" style="display: none;">
  ...
  <div class="modal-body form-horizontal">
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="typeahead input-large" id="product_name" autocomplete="off"
    ...
    <div class="control-group">
      <table class="table table-bordered" id="prdfnd" style="display: none;">
        ...
        <tr>
          <td colspan="2">
            <center><img id="prdimg" src=""/></center>
          </td>
        </tr>
        <tr>
          <th>
