...
<div class="span2 main-menu-span">
  <div class="well nav-collapse sidebar-nav">
    <ul class="nav nav-tabs nav-stacked main-menu">
      <li class="mynavheader"><a class="ajax-link" href="<?php echo base_url() . "admin/dashboard"; ?>"><i
            class="icon-home"></i><span class="">&nbsp;Dashboard</span></a></li>
      ...
      $links = array(
        ...
        1 => array(
          ...
          "data" => array(
            0 => array("url" => base_url() . "admin/product", "text" => "Products List", "module" => "product")
          )
        ),
        2 => array(
