...
<div class="row">
  <div id="gallery" class="span3">
    <a href="<?php echo $obj->product["product_image"] . "&width=500&height=500"; ?>"
       title="<?php echo $obj->product["product_name"]; ?>">
      <img id="prod-img" src="<?php echo $obj->product["product_image"]; ?>" style="width:100%"
           alt="<?php echo $obj->product["product_name"]; ?>"/>
    </a>
    <!--
  ...
  <div class="span6">
    ...
    <form class="form-horizontal qtyFrm"
          onsubmit="addtocartwithquantity($(this).attr('action')+'/'+$('#qty').val(),this,event);"
          action="<?php echo base_url() . 'cart/addtocart/' . $obj->product['product_id']; ?>">
      <div class="control-group">
        <label class="control-label">
          <?php
          if ($obj->product["discount_status"] == "1") {
            echo '
									<strong>Price&nbsp;:</strong>&nbsp;<span class = "price-number" style = "text-decoration:line-through;color : red;">Php.' . $obj->product["product_price"] . '/-</span><br />
									<strong>Discount&nbsp;Price&nbsp;:</strong>&nbsp;<span class = "price-number" style = "">Php.' . $obj->product["discount_price"] . '/- </span>
								';
          } else {
            echo '<strong>Price&nbsp;:</strong>&nbsp;<span class = "price-number">Php.' . $obj->product["product_price"] . '/-</span>';
          }
          ?>
        </label>
        <div class="controls" style="clear: both;margin-left: 0px;">
          <input type="number" id="qty" class="span1 num_inc" placeholder="Qty."/>
          <button type="submit" class="btn btn-large btn-success pull-right"> Add to cart <i
      ...
      <div class="tab-pane fade active in" id="home">
        ...
        <table class="table table-bordered">
          ...
          <tr class="techSpecRow">
            ...
            <td class="techSpecTD2"><?php echo $obj->productname; ?></td>
          </tr>
          <?php
              ...
              foreach ($this->product["related_Products"] as $products) {
                ...
                if ($products['discount_status'] == '1') {
                  echo '<strong>Price&nbsp;:</strong>&nbsp;<span class = "price-number" style = "text-decoration:line-through;color : red;">Rs.' . $products['product_price'] . '/-</span><br />
								<strong>Discount&nbsp;Price&nbsp;:</strong>&nbsp;<span class = "price-number" style = "">Php.' . $products['discount_price'] . '/- </span>';
                } else {
                  echo '<strong>Price&nbsp;:</strong>&nbsp;<span class = "price-number">Php.' . $products['product_price'] . '/-</span>';
                }
                echo '<br class="clr"/>
								</div>
  ...
  (
    function () {
      setInterval(function () {
        if (parseInt($(".num_inc").val()) < 1) $(".num_inc").val(1);
      })
    }
  );
</script>